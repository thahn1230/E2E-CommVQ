...
class DynamicCache(Cache):
    ...
    def __init__(self, num_hidden_layers: Optional[int] = None) -> None:
        ...
        if num_hidden_layers is None:
            ...
            self.quant_key_cache: List[torch.Tensor] = []
            self.quant_value_cache: List[torch.Tensor] = []
        else:
            ...
            self.quant_key_cache: List[torch.Tensor] = [[] for _ in range(num_hidden_layers)]
            self.quant_value_cache: List[torch.Tensor] = [[] for _ in range(num_hidden_layers)]
